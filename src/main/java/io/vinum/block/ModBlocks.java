...
public final class ModBlocks {
	...
	public static final RegistryObject<Block> CROP_AGAVE = register("crop_agave", () -> new AgaveCrop(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0F, 0.F).sound(SoundType.CROP)));

...
public final class PVItems {
	...
	public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, PVDefines.MODID);
	...
	public static final RegistryObject<Item> COOKED_AGAVE_PULP = ITEMS.register("cooked_agave_pulp", () -> new Item(new Item.Properties().food(Foods.DRIED_KELP).tab(PVItemGroup.MAIN)));
	...
	public static final RegistryObject<Item> JUICER = ITEMS.register("juicer", () -> new DontBreakOnCraftItem(PVItemGroup.PROPERTIES.stacksTo(1)));
	public static final RegistryObject<Item> ICE_PICK = ITEMS.register("ice_pick", () -> new DontBreakOnCraftItem(PVItemGroup.PROPERTIES.stacksTo(1)));
	public static final RegistryObject<Item> COCKTAIL_SHAKER = ITEMS.register("cocktail_shaker", () -> new DontBreakOnCraftItem(PVItemGroup.PROPERTIES.stacksTo(1)));
	public static final RegistryObject<Item> MARGARITA_GLASS_MOLD = ITEMS.register("margarita_glass_mold", () -> new DontBreakOnCraftItem(PVItemGroup.PROPERTIES.stacksTo(1)));
	...
	public static final RegistryObject<Item> APPLE_JUICE = ITEMS.register("apple_juice", () -> new Item(new Item.Properties().food(Foods.APPLE).tab(PVItemGroup.MAIN)));
	...
	public static final RegistryObject<Item> SPICED_APPLE_MARGARITA = ITEMS.register("spiced_apple_margarita", () -> new DrinkItem(PVItemGroup.PROPERTIES, 32, 2, new ItemStack(PVItems.MARGARITA_GLASS.get()), new EffectInstance(Effects.LUCK, 18000), new EffectInstance(Effects.JUMP, 12000), new EffectInstance(Effects.MOVEMENT_SPEED, 12000)));
	//BIG SHIM ENERGY
	public static final RegistryObject<Item> BARREL = ITEMS.register("barrel", () -> new DontBreakOnCraftItem(PVItemGroup.PROPERTIES.stacksTo(1)));
	
	public static final RegistryObject<Item> CINNAMON_SIGN = ITEMS.register("cinnamon_sign", () -> new PVSignItem(PVItemGroup.PROPERTIES.stacksTo(16), PVBlocks.CINNAMON_SIGN.get(), PVBlocks.CINNAMON_WALL_SIGN.get()));
	...
	public static final RegistryObject<Item> CINNABON = ITEMS.register("cinnabon", () -> new Item(new Item.Properties().food(Foods.PUMPKIN_PIE).tab(PVItemGroup.MAIN)));
}